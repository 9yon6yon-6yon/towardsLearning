...
<div class="main-area">
  <?php include('includes/left-sidebar.php'); ?>
    ...
    $ques = mysqli_query($db, "SELECT q_id, Status, question_detail, img, ques_points, username, Subject_Name, created_at  FROM questions q
       ...
       JOIN subjects sub ON q.subject_code=sub.s_code where sub.s_code = 4 ORDER BY created_at DESC") or die(mysqli_error($db));
      ...
      <div class="question" id="response">
        <div class="info">
          <div class="info-title">
            <img src="./uploads/<?php echo $q['img']; ?>" class="rounded-circle " height="35" width="35" alt="" loading="lazy" style="margin-right: 15px;" />
