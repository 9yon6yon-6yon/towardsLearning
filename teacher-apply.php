	...
	<div class="container">
		<form action="process.php" method="POST" enctype="multipart/form-data">
			<div class="row d-flex justify-content-around">
				...
				<div class="col-5">
					<div class="mb-3 mt-5  px-1 d-flex justify-content-center">
						<button type="submit" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#exampleModal" style="border-radius: 30px !important;" name="teacherapply">Submit</button>
					</div>
				</div>
			</div>
		</form>
