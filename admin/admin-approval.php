	...
	<div class="main">
		...
		<div class="content">
			...
			<table class="table">
				...
				<?php
				$stu = mysqli_query($db, "SELECT * FROM teacher where status='Unapproved'") or die(mysqli_error($db));
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><img src="../uploads/<?php echo $s['profile_pic']; ?>" height="50" width="50" alt="" loading="lazy" /></td>
							<td><?php echo $s['id']; ?></td>
